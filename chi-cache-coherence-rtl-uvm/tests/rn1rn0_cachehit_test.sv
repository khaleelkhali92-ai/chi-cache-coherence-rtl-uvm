class rn1rn0_cachehit_test extends my_chi_test;

    `uvm_component_utils(rn1rn0_cachehit_test)


    function new(string name = "rn1rn0_cachehit_test",
    ...
    task run_phase(uvm_phase phase);
        ...
        write_seq =
            my_chi_write_seq::type_id::create("write_seq");

      write_seq.start(env.rn1_agt.seqr);

        read_seq1 = my_chi_read_seq::type_id::create("read_seq1");
      write_seq.seq_addr = 32'h00000200;
      write_seq.seq_data = 32'h55555555;

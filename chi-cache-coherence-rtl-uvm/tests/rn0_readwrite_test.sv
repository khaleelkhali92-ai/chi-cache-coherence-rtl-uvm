class rn0_readwrite_test extends my_chi_test;

  `uvm_component_utils(rn0_readwrite_test)


    function new(string name = "rn0_readwrite_test",
    ...
    task run_phase(uvm_phase phase);
      ...
      write_seq.seq_addr = 32'h00000010;
      write_seq.seq_data = 32'h11111111;
